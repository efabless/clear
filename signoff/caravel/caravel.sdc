...
# clocks
create_clock -name op_clk -period 100 [get_ports {mprj_io[36]}] 
set_clock_uncertainty 0.1000 [get_clocks {op_clk}]
set_propagated_clock [get_clocks {op_clk}]
create_clock -name prog_clk -period 100 [get_ports {mprj_io[37]}] 
set_clock_uncertainty 0.1000 [get_clocks {prog_clk}]
...
# input transition
set_input_transition -min $min_clk_tran [get_ports {mprj_io[36]}] 
set_input_transition -max $max_clk_tran [get_ports {mprj_io[36]}] 
set_input_transition -min $min_clk_tran [get_ports {mprj_io[37]}] 
set_input_transition -max $max_clk_tran [get_ports {mprj_io[37]}]
...
if {$ios_mode == "IN"} {
   ...
   ## INPUT DELAYS
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[0]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[5]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[6]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[7]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[8]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[9]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[10]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[11]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[12]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[13]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[14]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[15]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[16]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[17]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[18]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[19]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[20]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[21]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[22]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[23]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[24]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[25]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[26]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[27]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[28]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[29]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[30]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[31]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[32]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[33]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[34]}]
   set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[35]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[36]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[37]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[0]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[5]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[6]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[7]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[8]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[9]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[10]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[11]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[12]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[13]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[14]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[15]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[16]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[17]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[18]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[19]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[20]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[21]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[22]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[23]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[24]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[25]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[26]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[27]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[28]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[29]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[30]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[31]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[32]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[33]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[34]}]
   set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[35]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[36]}]
   # set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[37]}]
   ...
   if {$io_4_mode == "SCK"} {
      ...
      set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[1]}]
      set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[2]}]
      set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[3]}]
      set_input_delay $input_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[4]}] 
   ...
   ## OUTPUT DELAYS
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[0]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[5]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[6]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[7]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[8]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[9]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[10]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[11]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[12]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[13]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[14]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[15]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[16]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[17]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[18]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[19]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[20]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[21]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[22]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[23]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[24]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[25]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[26]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[27]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[28]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[29]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[30]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[31]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[32]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[33]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[34]}]
   set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[35]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[36]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {clk}] [get_ports {mprj_io[37]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[0]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[5]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[6]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[7]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[8]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[9]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[10]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[11]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[12]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[13]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[14]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[15]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[16]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[17]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[18]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[19]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[20]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[21]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[22]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[23]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[24]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[25]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[26]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[27]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[28]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[29]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[30]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[31]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[32]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[33]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[34]}]
   set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[35]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[36]}]
   # set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[37]}]
   if {$io_4_mode == "SCK"} {
      ...
      set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[1]}]
      set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[2]}]
      set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[3]}]
      set_output_delay $output_delay_value  -clock [get_clocks {op_clk}] [get_ports {mprj_io[4]}] 
      if { !($::env(IO_SYNC)) } {
...
# inputs
# IO[22]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[3]/DM[2]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[3]/DM[1]]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area2_io_pad[3]/DM[0]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[3]/INP_DIS]
set_input_transition -min $min_clk_tran [get_ports {mprj_io[22]}] 
set_input_transition -max $max_clk_tran [get_ports {mprj_io[22]}]
set_input_delay $input_delay_value -clock [get_clocks {clk}] [get_ports {mprj_io[22]}]
set_input_delay $input_delay_value -clock [get_clocks {op_clk}] [get_ports {mprj_io[22]}]
# IO[34]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[15]/DM[2]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[15]/DM[1]]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area2_io_pad[15]/DM[0]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[15]/INP_DIS]
set_input_transition -min $min_clk_tran [get_ports {mprj_io[34]}] 
set_input_transition -max $max_clk_tran [get_ports {mprj_io[34]}]
set_input_delay $input_delay_value -clock [get_clocks {prog_clk}] [get_ports {mprj_io[34]}]

# outputs
# IO[14]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area1_io_pad[14]/DM[2]]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area1_io_pad[14]/DM[1]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area1_io_pad[14]/DM[0]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area1_io_pad[14]/OE_N]
set_load -min $min_cap [get_ports {mprj_io[14]}] 
set_load -max $max_cap [get_ports {mprj_io[14]}]  
set_output_delay $output_delay_value -clock [get_clocks {clk}] [get_ports {mprj_io[14]}]
set_output_delay $output_delay_value -clock [get_clocks {op_clk}] [get_ports {mprj_io[14]}]
# IO[23]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area2_io_pad[4]/DM[2]]
set_case_analysis 1 [get_pins padframe/\mprj_pads.area2_io_pad[4]/DM[1]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[4]/DM[0]]
set_case_analysis 0 [get_pins padframe/\mprj_pads.area2_io_pad[4]/OE_N]
set_load -min $min_cap [get_ports {mprj_io[23]}] 
set_load -max $max_cap [get_ports {mprj_io[23]}]  
set_output_delay $output_delay_value -clock [get_clocks {prog_clk}] [get_ports {mprj_io[23]}]
