...
set_input_delay 1 -clock [get_clocks {prog_clk}] [all_inputs]
set_output_delay 1 -clock [get_clocks {prog_clk}] [all_outputs]

create_clock -name clk -period 100 [get_ports {io_in[36]}]
