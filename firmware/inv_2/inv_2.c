#include <common.h>
// #include "../fpga_bitstreams/inv_2.h"
...
void main()
{
    ...
    // inverter inputs
    configure_gpio(19, GPIO_MODE_USER_STD_INPUT_NOPULL);
    configure_gpio(26, GPIO_MODE_USER_STD_INPUT_NOPULL);
    configure_gpio(28, GPIO_MODE_USER_STD_INPUT_NOPULL);
    configure_gpio(30, GPIO_MODE_USER_STD_INPUT_NOPULL);
    configure_gpio(31, GPIO_MODE_USER_STD_INPUT_NOPULL);
    configure_gpio(32, GPIO_MODE_USER_STD_INPUT_NOPULL);
