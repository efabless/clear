...
set spef_mapping(clocking)                           $::env(CARAVEL_ROOT)/spef/caravel_clocking_$::env(SPEF_CORNER).spef
...
set spef_mapping(gpio_control_bidir_2[0])   $::env(CARAVEL_ROOT)/spef/gpio_control_block_mgmt_$::env(SPEF_CORNER).spef
set spef_mapping(gpio_control_bidir_2[1])   $::env(CARAVEL_ROOT)/spef/gpio_control_block_mgmt_$::env(SPEF_CORNER).spef
set spef_mapping(gpio_control_bidir_2[2])   $::env(CARAVEL_ROOT)/spef/gpio_control_block_mgmt_$::env(SPEF_CORNER).spef
...
set spef_mapping(gpio_defaults_block_2[2])   $::env(CARAVEL_ROOT)/spef/gpio_defaults_block_$::env(SPEF_CORNER).spef
...
#set spef_mapping(mprj)                       $::env(CARAVEL_ROOT)/spef/user_project_wrapper_$::env(SPEF_CORNER).spef
...
#set spef_mapping(por)                        $::env(CARAVEL_ROOT)/spef/simple_por_$::env(SPEF_CORNER).spef
set spef_mapping(soc)                        $::env(CARAVEL_ROOT)/spef/mgmt_core_wrapper_$::env(SPEF_CORNER).spef
set spef_mapping(spare_logic[0])             $::env(CARAVEL_ROOT)/spef/spare_logic_block_$::env(SPEF_CORNER).spef
set spef_mapping(spare_logic[1])             $::env(CARAVEL_ROOT)/spef/spare_logic_block_$::env(SPEF_CORNER).spef
set spef_mapping(spare_logic[2])             $::env(CARAVEL_ROOT)/spef/spare_logic_block_$::env(SPEF_CORNER).spef
set spef_mapping(spare_logic[3])             $::env(CARAVEL_ROOT)/spef/spare_logic_block_$::env(SPEF_CORNER).spef
